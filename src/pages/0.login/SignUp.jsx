      ...
      <div className="w-1/2 h-[80%] border border-red-500 bg-[#f5f5f5] flex flex-col pl-20 justify-between">
        ...
        <div className="w-full flex flex-col max-w-[450px]">
          <div className="w-full flex flex-col mb-2">
            <h3 className="text-2xl text-center font-semibold my-2">Register</h3>
            <p className="text-xl mb-2">Sign Up for better experience</p>
          </div>
        ...
        <div className="w-full flex items-center justify-center">
          <p className="text-sm font-normal text-[#060606]">Already a user  ,
