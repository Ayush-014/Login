...
//       <div className="absolute top-0 h-[80%] w-1/2 bg-[url('/home/kartik/E/vs/React/route/route/public/purple-aesthetic-train-57-1366x768.jpg')]">
...
const Login = () => {
  return (
    <div className="w-full h-screen min-h-screen flex items-start">
      ...
      <div className="relative w-1/2 h-[80%] flex flex-col border border-green-400">
      ...
      <div className="w-1/2 h-[80%] border border-red-500 bg-[#f5f5f5] flex flex-col pl-20 justify-between">

        <div className="w-full flex flex-col max-w-[450px]">
          <div className="w-full flex flex-col mb-2">
            <h3 className="text-2xl text-center font-semibold my-2">Login</h3>
